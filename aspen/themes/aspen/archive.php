...
<div id="main-content">	
	...
	<div class="grid-8col">
      ...
      <?php if (have_posts()) : ?>
        ...
        <h3 class="team-head"><?php if ( is_day() ) : ?>
				<?php printf( __( 'Daily Archive for <span>%s</span>', 'twentyten' ), get_the_date() ); ?>
			<?php elseif ( is_month() ) : ?>
				<?php printf( __( 'Monthly Archive for <span>%s</span>', 'twentyten' ), get_the_date( 'F Y' ) ); ?>
			<?php elseif ( is_year() ) : ?>
				<?php printf( __( 'Yearly Archive for <span>%s</span>', 'twentyten' ), get_the_date( 'Y' ) ); ?>
			<?php else : ?>
