...
<?php if ( have_comments() ) : ?>
	...
	<div class="dateDiv"><?php comment_date('F jS, Y') ?> | <a href="#comment-<?php comment_ID() ?>" title=""><?php comment_author() ?></a></div>
	<div class="textComments"><?php comment_text() ?></div>
...
<h3><?php comment_form_title( __('Post a Reply', ' '), __('Post a Reply for %s' , ' ') ); ?></h3>
...
<div class="nameInput"><?php _e('Comments', ' '); ?></div>
<textarea name="comment" id="comment" cols=" " rows=" " tabindex="4"></textarea><br />
