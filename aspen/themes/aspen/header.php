...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	<head profile="http://gmpg.org/xfn/11">
		...
		<link rel="alternate" type="application/rss+xml" title="RSS 2.0 Feed for Posts from Aspen Management (the main feed)" href="<?php bloginfo('rss2_url'); ?>" />
		...
		<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>?r=0921" type="text/css" media="screen" />
		...
		<script type="text/javascript">
		  var _gaq = _gaq || [];
		  _gaq.push(['_setAccount', 'UA-6603360-8']);
	...
	<body>
	<a name="top"></a> 
	<a class="cufac" href="mailto:manager@aspen-mgmt.com"></a>
